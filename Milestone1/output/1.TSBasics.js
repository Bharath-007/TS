...
let employeeName; //delare variable employeeName of type String
employeeName = 'Arun'; //assign variable employeeName
let isPermanent = true; //defining the variable with type boolean
let age = 21;
let multiple = (num) => {
    return num * 10;
};
...
let sampleArray1 = [6, 32, 1, 23, 32];
let isBoolean = [false, true, false, true];
let nameArray = ['Virav', 'Vikas'];
